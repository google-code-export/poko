...
class hscript_Expr extends Enum {
	...
	public static function EFunction($params, $e, $name = null) { return new hscript_Expr("EFunction", 14, array($params, $e, $name)); }
	...
	public static function ETry($e, $v, $ecatch) { return new hscript_Expr("ETry", 20, array($e, $v, $ecatch)); }
	public static function EUnop($op, $prefix, $e) { return new hscript_Expr("EUnop", 7, array($op, $prefix, $e)); }
	public static function EVar($n, $e = null) { return new hscript_Expr("EVar", 2, array($n, $e)); }
	public static function EWhile($cond, $e) { return new hscript_Expr("EWhile", 10, array($cond, $e)); }
	public static $__constructors = array(16 => 'EArray', 17 => 'EArrayDecl', 6 => 'EBinop', 4 => 'EBlock', 12 => 'EBreak', 8 => 'ECall', 0 => 'EConst', 13 => 'EContinue', 5 => 'EField', 11 => 'EFor', 14 => 'EFunction', 1 => 'EIdent', 9 => 'EIf', 18 => 'ENew', 21 => 'EObject', 3 => 'EParent', 15 => 'EReturn', 19 => 'EThrow', 20 => 'ETry', 7 => 'EUnop', 2 => 'EVar', 10 => 'EWhile');
	}
