...
class site_cms_modules_base_helper_MenuDef {
	public function __construct($headings, $items) {
		...
		$this->headings = site_cms_modules_base_helper_MenuDef_0($this, $headings, $items);
		$this->items = site_cms_modules_base_helper_MenuDef_1($this, $headings, $items);
...
;
function site_cms_modules_base_helper_MenuDef_0(&$»this, &$headings, &$items) {
if($headings !== null) {
	return $headings;
	;
}
...
function site_cms_modules_base_helper_MenuDef_1(&$»this, &$headings, &$items) {
if($items !== null) {
	return $items;
	;
}
