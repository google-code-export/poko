...
class site_cms_CmsController extends poko_controllers_HtmlController {
	...
	public function init() {
		...
		$this->user = site_cms_CmsController_0($this);
		$this->user->update();
...
;
function site_cms_CmsController_0(&$»this) {
if(php_Session::get("user")) {
	return php_Session::get("user");
	;
}
else {
	return new site_cms_common_User();
	;
}
}