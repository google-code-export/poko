...
class poko_form_elements_RichtextWym extends poko_form_FormElement {
	...
	public function render() {
		...
		$str->b .= "\x09\x09stylesheet: './css/site.css',";
		...
		$str->b .= "\x09{'name': 'InsertImage', 'title': 'Image', 'css': 'wym_tools_image'},";
		...
		$str->b .= "],";
		$str->b .= "containersItems: [";
		$str->b .= "\x09{'name': 'P', 'title': 'Paragraph', 'css': 'wym_containers_p'}";
		$str->b .= "],";
