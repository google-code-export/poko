...
$this->buf .= '
			...
			';
if(_hxtemplo_is_true($ctx->application->user->authenticated)) {
$this->buf .= '
			<ul id="headingUserBox">
				<div id="headingUserBoxName">Hello <b>';
$this->buf .= _hxtemplo_string($ctx->userName);
$this->buf .= '</b></div>
				<div id="headingUserBoxLogout"><a href="?request=cms.Index&logout=true">logout</a></div>
			</ul>
			';
}
$this->buf .= '
		...
		';
if(_hxtemplo_length($ctx->messages) > 0) {
$this->buf .= '
			<div class="messageBlock" id="messageMessages"><ul>
				';
$repeater_m = _hxtemplo_repeater($ctx->messages);  while($repeater_m->hasNext()) {$ctx->m = $repeater_m->next(); 
$this->buf .= '
					<li> ';
$this->buf .= $ctx->m;
$this->buf .= '</li>
...
$this->buf .= '
		...
		';
if(_hxtemplo_length($ctx->warnings) > 0) {
$this->buf .= '
			<div class="messageBlock" id="messageWarnings"><ul>
				';
$repeater_m = _hxtemplo_repeater($ctx->warnings);  while($repeater_m->hasNext()) {$ctx->m = $repeater_m->next(); 
$this->buf .= '
					<li> ';
$this->buf .= $ctx->m;
$this->buf .= ' </li>
...
$this->buf .= '
		...
		';
if(_hxtemplo_length($ctx->errors) > 0) {
$this->buf .= '
			<div class="messageBlock" id="messageErrors"><ul>
				';
$repeater_m = _hxtemplo_repeater($ctx->errors);  while($repeater_m->hasNext()) {$ctx->m = $repeater_m->next(); 
$this->buf .= '
					<li> ';
$this->buf .= $ctx->m;
$this->buf .= ' </li>
...
$this->buf .= '
		...
		';
if(_hxtemplo_length($ctx->debugs) > 0) {
$this->buf .= '
			<div class="messageBlock" id="messageDebugs"><ul>
				';
$repeater_m = _hxtemplo_repeater($ctx->debugs);  while($repeater_m->hasNext()) {$ctx->m = $repeater_m->next(); 
$this->buf .= '
					<li> ';
$this->buf .= $ctx->m;
$this->buf .= ' </li>
...
$this->buf .= $ctx->leftNavigation;
$this->buf .= '</div>
		<div id="content">';
$this->buf .= $ctx->controller->getRequestContent();
$this->buf .= '</div>
