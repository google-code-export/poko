...
class MenuDef 
{
	...
	public function addItem(id:Int, type:MenuItemType, name:String, ?heading:String = null, ?indent:Int = 0, ?listChildren:String = null, ?linkChild:{dataset:String, id:String} = null)
	{
		items.push( {
			id: id,
			type: type,
...
typedef MenuItem = {
	...
	var linkChild:{dataset:String, id:String};
}
