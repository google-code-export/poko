			...
			if(j[n].className == "sectionSeperator") {
				...
				var items = new JQuery("li",j[n]);
				{
					...
					while(_g3 < _g2) {
						...
						var tId = d.id;
						var tType = d.type;
						var tProp = j2.attr("prop");
						var t2Prop = null;
						var t2PropD = null;
						if(tProp != null) {
							var args = tProp.split(",");
							if(args.length > 1) {
								switch(args[0]) {
								case "filter":{
									t2Prop = args[1];
								...
								case "link":{
									t2PropD = { dataset : args[1], id : args[2]}
								}break;
								}
							}
						}
						m.addItem(tId,tType,itemName,headingName,tIndent,t2Prop,t2PropD);
					}
				}
			}
		}
...
site.cms.modules.base.js.JsSiteView.prototype.refreshBehaviour = function() {
	...
	new JQuery("a.propertiesItemInner").unbind("click",$closure(this,"propertiesItem"));
	new JQuery("a.propertiesItemInner").bind("click",null,$closure(this,"propertiesItem"));
}
...
site.cms.modules.base.js.JsDataset.prototype.onGetFilterInfo = function(response) {
	...
	case "association":case "bool":case "enum":{
...
if(!site.cms.modules.email) site.cms.modules.email = {}
if(!site.cms.modules.email.js) site.cms.modules.email.js = {}
site.cms.modules.email.js.JsSettings = function(p) { if( p === $_ ) return; {
	poko.js.JsRequest.apply(this,[]);
}}
site.cms.modules.email.js.JsSettings.__name__ = ["site","cms","modules","email","js","JsSettings"];
site.cms.modules.email.js.JsSettings.__super__ = poko.js.JsRequest;
for(var k in poko.js.JsRequest.prototype ) site.cms.modules.email.js.JsSettings.prototype[k] = poko.js.JsRequest.prototype[k];
site.cms.modules.email.js.JsSettings.prototype.emailField = null;
site.cms.modules.email.js.JsSettings.prototype.idField = null;
site.cms.modules.email.js.JsSettings.prototype.nameField = null;
site.cms.modules.email.js.JsSettings.prototype.onChangeSelectbox = function(selectBox) {
	this.remoting.resolve("api").resolve("getTableFields").call([selectBox.value],$closure(this,"onGetTableFields"));
	this.emailField = js.Lib.document.getElementById("form_emailField");
	this.nameField = js.Lib.document.getElementById("form_nameField");
	this.idField = js.Lib.document.getElementById("form_idField");
	this.emailField.innerHTML = "<option value=\"\">-- loading --</option>";
	this.nameField.innerHTML = "<option value=\"\">-- loading --</option>";
	this.idField.innerHTML = "<option value=\"\">-- loading --</option>";
}
site.cms.modules.email.js.JsSettings.prototype.onGetTableFields = function(fields) {
	var innerHtml = "";
	if(fields != null) {
	...
	this.emailField.innerHTML = innerHtml;
	this.nameField.innerHTML = innerHtml;
	this.idField.innerHTML = innerHtml;
}
site.cms.modules.email.js.JsSettings.prototype.__class__ = site.cms.modules.email.js.JsSettings;
...
site.cms.modules.media.js.JsMediaSelector.__name__ = ["site","cms","modules","media","js","JsMediaSelector"];
site.cms.modules.media.js.JsMediaSelector.__super__ = poko.js.JsRequest;
for(var k in poko.js.JsRequest.prototype ) site.cms.modules.media.js.JsMediaSelector.prototype[k] = poko.js.JsRequest.prototype[k];
site.cms.modules.media.js.JsMediaSelector.prototype.fileBrowserDialogue = null;
site.cms.modules.media.js.JsMediaSelector.prototype.gallery = null;
site.cms.modules.media.js.JsMediaSelector.prototype.main = function() {
	new JQuery("#form1_submit").hide();
	var gallerySelector = js.Lib.document.getElementById("form1_galleryList");
	gallerySelector.onchange = function(e) {
		var f = js.Lib.document.getElementById("form1");
		f.submit();
	}
	if(js.Lib.window.opener != null) this.wymOpener = js.Lib.window.opener;
}
site.cms.modules.media.js.JsMediaSelector.prototype.wymOpener = null;
site.cms.modules.media.js.JsMediaSelector.prototype.__class__ = site.cms.modules.media.js.JsMediaSelector;
...
site.cms.modules.base.js.JsDefinitionElement.prototype.onAssocDataLoaded2 = function(response) {
	this.assocSelectBox2.innerHTML = "";
	this.assocSelectBox3.innerHTML = "";
	{
		var _g = 0, _g1 = response[0];
		while(_g < _g1.length) {
			var item = _g1[_g];
			++_g;
			this.assocSelectBox2.innerHTML += ((("<option value=\"" + item) + "\">") + item) + "</option>";
...
site.cms.modules.base.js.JsDefinitionElement.prototype.onChangeSelectbox = function(selectBox) {
	...
	case "form_def_post-sql-value_table":{
		this.assocSelectBox1 = js.Lib.document.getElementById("form_def_post-sql-value_table");
		this.assocSelectBox2 = js.Lib.document.getElementById("form_def_post-sql-value_updateTo");
		this.assocSelectBox3 = js.Lib.document.getElementById("form_def_post-sql-value_updateKey");
		var inputTemp = js.Lib.document.getElementById("form_def_post-sql-value_updateKeyTable");
	...
	if(secondTable != null) {
		this.remoting.resolve("api").resolve("getListData2").call([this.assocSelectBox1.value,secondTable],$closure(this,"onAssocDataLoaded2"));
	}
	else {
...
site.cms.modules.media.js.JsGallery.prototype.getPreview = function(item) {
	...
	return (function($this) {
		...
		case "TXT":{
			$r = JQuery.create("img",{ src : "./res/cms/media/file_txt.png"});
		}break;
		case "MP3,WAV,AC3,AAC":{
			$r = JQuery.create("img",{ src : "./res/cms/media/file_misc.png"});
		}break;
