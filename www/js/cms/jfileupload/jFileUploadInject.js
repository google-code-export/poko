...
(function( window, undefined ) {
	...
	var jFileUploadInject = function() {
		return new jFileUploadInject.fn.init();
	};
	...
	jFileUploadInject.fn = jFileUploadInject.prototype = {
		init: function()
		{
		},
	...
	// Expose to window
	window.jFileUploadInject = jFileUploadInject;
	window.jFileUploadInject.insert = window.jFileUploadInject.fn.insert;
