...
<form name="" id="" action="" method="post">
	...
	<input type="hidden" name="siteView" id="siteView" value="';
$this->buf .= _hxtemplo_string($ctx->siteViewSerialized);
$this->buf .= '"/>
	<input type="hidden" name="siteViewHidden" id="siteViewHidden" value="';
$this->buf .= _hxtemplo_string($ctx->siteViewHiddenSerialized);
$this->buf .= '"/>
