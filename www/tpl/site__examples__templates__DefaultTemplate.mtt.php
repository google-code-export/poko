...
$this->buf .= '
			<!-- START PAGE CONTENT -->
			';
$this->bufferCreate();$t_src_examples__site__examples__templates__DefaultTemplate__mtt_0 = $ctx->request_content_file;$this->includeTemplate($t_src_examples__site__examples__templates__DefaultTemplate__mtt_0, 'src_examples__site__examples__templates__DefaultTemplate__mtt', $ctx);
$this->buf .= '
			<!-- END PAGE CONTENT -->
	</div>
</body>
