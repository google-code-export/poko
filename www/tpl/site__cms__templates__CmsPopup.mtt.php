...
<body>
	...
	<div id="container">
		';
if(_hxtemplo_length($ctx->messages) > 1) {
$this->buf .= '
...
$this->buf .= '
					<li> ';
$this->buf .= _hxtemplo_string($ctx->m);
$this->buf .= '</li>
				';
}
$this->buf .= '
...
$this->buf .= '
		...
		';
if(_hxtemplo_length($ctx->warnings) > 1) {
$this->buf .= '
...
$this->buf .= '
		...
		';
if(_hxtemplo_length($ctx->errors) > 1) {
$this->buf .= '
...
$this->buf .= '</div>
	...
	';
$this->buf .= _hxtemplo_string($ctx->head->getJsCalls());
$this->buf .= '	
</body>
</html>
';
