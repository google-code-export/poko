...
$ctx->cols = _hxtemplo_add($ctx->cols,1);
$this->buf .= '
						<td><a class="qTip" title="Edit" href="?request=cms.modules.base.DatasetItem&action=edit&dataset=';
$this->buf .= _hxtemplo_string($ctx->dataset);
$this->buf .= '&id=';
$this->buf .= _hxtemplo_string($ctx->row->cms_primaryKey);
$this->buf .= '&linkMode=';
...
$this->buf .= '&autofilterByAssoc=';
$this->buf .= _hxtemplo_string($ctx->autoFilterByAssocValue);
$this->buf .= '"><img src="./res/cms/page_copy.png"/></a></td>
					</tr>
				';
}
$this->buf .= '
...
$this->buf .= '
			...
			<input type="submit" id="datasetDeleteButton" name="submitted_delete" value="';
if(_hxtemplo_is_true($ctx->isOrderingEnabled)) {
$this->buf .= ' delete & order ';
} else {
$this->buf .= ' delete checked ';
}
$this->buf .= '"/>
	</form>
