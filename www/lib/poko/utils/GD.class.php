...
class poko_utils_GD {
	...
	static function getImageSize($filename, $imageinfo) {
		...
		$mime = null;
		try {
			$bits = poko_utils_GD_0($a, $bits, $channels, $filename, $imageinfo, $mime, $types);
			$channels = poko_utils_GD_1($a, $bits, $channels, $filename, $imageinfo, $mime, $types);
			$mime = poko_utils_GD_2($a, $bits, $channels, $filename, $imageinfo, $mime, $types);
			;
		}catch(Exception $»e) {
		...
		unset($types,$mime,$e,$channels,$bits,$a);
	}
	static function image_type_to_extension($imagetype, $include_dot) {
		$t = poko_utils_GD_3($imagetype, $include_dot);
		return poko_utils_GD_4($imagetype, $include_dot, $t);
		unset($t);
	}
	static function imageTypeToMimeType($imagetype) {
		return poko_utils_GD_5($imagetype);
		;
	}
...
;
function poko_utils_GD_0(&$a, &$bits, &$channels, &$filename, &$imageinfo, &$mime, &$types) {
if($a[4] !== null) {
	return $a[4];
	;
}
}
function poko_utils_GD_1(&$a, &$bits, &$channels, &$filename, &$imageinfo, &$mime, &$types) {
if($a[5] !== null) {
	return $a[5];
	;
}
}
function poko_utils_GD_2(&$a, &$bits, &$channels, &$filename, &$imageinfo, &$mime, &$types) {
if($a[6] !== null) {
	return $a[6];
	;
}
}
function poko_utils_GD_3(&$imagetype, &$include_dot) {
switch($imagetype) {
...
function poko_utils_GD_4(&$imagetype, &$include_dot, &$t) {
if($include_dot) {
	return "." . $t;
	;
}
...
function poko_utils_GD_5(&$imagetype) {
switch($imagetype) {
case poko_utils_ImageType::$GIF:{
	return "image/gif";
	;
...
function poko_utils_GD_6(&$img, &$x_size, &$y_size) {
if(Std::is($img, _hx_qtype("Bool"))) {
	return null;
	;
}
else {
...
function poko_utils_GD_7(&$filename, &$img) {
if(Std::is($img, _hx_qtype("Bool"))) {
	return null;
	;
}
...
function poko_utils_GD_8(&$filename, &$img) {
if(Std::is($img, _hx_qtype("Bool"))) {
	return null;
	;
}
...
function poko_utils_GD_9(&$filename, &$img) {
if(Std::is($img, _hx_qtype("Bool"))) {
	return null;
	;
}
...
function poko_utils_GD_10(&$filename, &$img) {
if(Std::is($img, _hx_qtype("Bool"))) {
	return null;
	;
}
...
function poko_utils_GD_11(&$filename, &$img) {
if(Std::is($img, _hx_qtype("Bool"))) {
	return null;
	;
}
...
function poko_utils_GD_12(&$filename, &$img) {
if(Std::is($img, _hx_qtype("Bool"))) {
	return null;
	;
}
...
function poko_utils_GD_13(&$filename, &$img) {
if(Std::is($img, _hx_qtype("Bool"))) {
	return null;
	;
}
...
function poko_utils_GD_14(&$img, &$x_size, &$y_size) {
if(Std::is($img, _hx_qtype("Bool"))) {
	return null;
	;
}
