...
class poko_form_elements_Richtext extends poko_form_FormElement {
	...
	public function render() {
		...
		$str->b .= ("\x0A\x09\x09theme : \"" . (poko_form_elements_Richtext_0($this, $n, $str))) . "\",\x09 \x09";
...
;
function poko_form_elements_Richtext_0(&$»this, &$n, &$str) {
if($»this->mode == poko_form_elements_RichtextMode::$SIMPLE) {
	return "simple";
	;
}
else {
