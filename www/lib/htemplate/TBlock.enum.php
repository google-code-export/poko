...
class htemplate_TBlock extends Enum {
	...
	public static $__constructors = array(6 => 'captureBlock', 7 => 'captureCloseBlock', 8 => 'closeBlock', 9 => 'codeBlock', 3 => 'elseBlock', 2 => 'elseifBlock', 4 => 'forBlock', 1 => 'ifBlock', 0 => 'literal', 10 => 'printBlock', 5 => 'whileBlock');
	}
