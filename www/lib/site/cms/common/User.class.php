...
class site_cms_common_User {
	...
	public function update() {
		if($this->authenticated) {
			...
			if($data !== null) {
				$this->groups = site_cms_common_User_0($this, $data);
				$this->id = $data->id;
				$this->name = $data->name;
				;
			}
...
;
function site_cms_common_User_0(&$»this, &$data) {
if(_hx_field($data, "groups") !== null) {
	return _hx_string_call($data->groups, "split", array(","));
	;
}
else {
