...
class site_cms_Index extends site_cms_templates_CmsTemplate {
	...
	public function main() {
		...
		if($this->app->params->get("submitted") !== null) {
			$username = $this->app->getDb()->quote($this->app->params->get("username"));
			$password = $this->app->getDb()->quote(haxe_Md5::encode($this->app->params->get("password")));
